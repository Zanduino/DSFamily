...
The following constant can/should be adjusted according to the 1-Wire configuration and user
preferences:\n "ONE_WIRE_PIN"           is the Arduino pin on which the data line of the 1-Wire
system is attached\n\n

The precision of the DS-Family devices is programmable from 9 to 12 bits and the granularity of
readings is 0.0625°C. All temperature readings coming back from the library are signed 16 bit
numbers in increments of 0.0625°C. This means if a temperature reading is "355" it equates
to 21.875°C.
